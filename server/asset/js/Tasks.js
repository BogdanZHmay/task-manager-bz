    ...
    var Tasks = function () {
        ...
        _createClass(Tasks, [{
            ...
            value: function init() {
                ...
                this.checkToken(self).then(this.getTasks).then(this.sortTasks).then(this.render).then(this.addEvent).then(Tasks.hidePreloader).then(this.changeColorTheme).then(this.addNewTask).catch(this.errorHandler);
            }
        }, {
            key: 'checkToken',
            ...
            value: function changeColorTheme() {
                ...
                var blocks = $('[data-change]');
                var tabs_color = $('[data-change-color]');
            ...
            key: 'editCurrentTask',
            value: function editCurrentTask(self) {
                $.ajax({
